package com.strqtz.skyblockmodules.gui.buttons;
...
public class Button extends GuiButton {
    ...
    public Button(int buttonId, int x, int y, double width, double height, double scale, String text, String text2, Integer text2Offset) {
